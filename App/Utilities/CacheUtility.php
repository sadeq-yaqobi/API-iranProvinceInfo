...
class CacheUtility
{
    protected static $cache_file; //cash file address
    protected static $cache_enabled = CACHE_ENABLED;
    const EXPIRE_TIME = 3600;   // 1 hour

    public static function init() //create cache file
    {
        self::$cache_file = CACHE_DIR . md5($_SERVER['REQUEST_URI']) . ".json"; //create a json file for unique cache keys consider the URL
